...
const GeocoderControl: FC<GeocoderControlProps> = (props) => {
  const [marker, setMarker] = useState<ReturnType<typeof Marker>>(
  ...
  const geocoder = useControl<MapboxGeocoder>(
    () => {
      ...
      if (props.onResults) ctrl.on('loading', props.onResults);
      ...
      ctrl.on('result', (evt) => {
        ...
        if (location && props.marker && props.marker !== true) {
          setMarker(
            <Marker
              {...props.marker}
